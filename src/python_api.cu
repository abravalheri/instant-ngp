...
PYBIND11_MODULE(pyngp, m) {
	...
	testbed
		...
		.def("nerf_matrix_to_ngp", &Testbed::nerf_matrix_to_ngp)
		.def("ngp_matrix_to_nerf", &Testbed::ngp_matrix_to_nerf)
		.def("set_nerf_camera_matrix", &Testbed::set_nerf_camera_matrix)
		.def("get_nerf_camera_matrix", &Testbed::get_nerf_camera_matrix)
